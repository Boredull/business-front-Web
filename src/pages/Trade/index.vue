  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ userDefaultAddrss.fullAddress }}</span>
        收货人：<span>{{ userDefaultAddrss.consignee }}</span>
        <span>{{ userDefaultAddrss.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
   ...
   async submitOrder() {
      ...
      let data = {
        consignee: this.userDefaultAddrss.consignee,//最终收件人的名字
        consigneeTel: this.userDefaultAddrss.phoneNum,//最终收件人的手机号
        deliveryAddress: this.userDefaultAddrss.fullAddress,//收件人的地址
